...
import com.datastax.examples.user.UserDao;
...
public class SpringBootCassandraConfiguration {
    ...
    @Bean
    public UserDao userDao(CqlSession session) {
        return new UserDao(session, keyspace, localDataCenter, astraSecureConnectBundle);
    }
}